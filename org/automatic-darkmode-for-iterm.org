...
- tags :: [[file:automatic-darkmode-in-vim.org][Automatic Darkmode with Vim]]
...
Similar to [[file:automatic-darkmode-in-vim.org][Automatic Darkmode with Vim]], this will check the system appearance every two seconds and set the profile accordingly.
